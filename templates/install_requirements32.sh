...
# by any *32-bit* Pythia code.
#
# To install the dependencies for a plugin, simply drag a requirements.txt
# file onto install_requirements32.sh
#############################################################################

interpreter=`dirname "$0"`/python-{version}-embed-linux32

echo ===============================================================================
echo Installing requirements for $interpreter from "$1"...
echo ===============================================================================

"${interpreter}"/bin/python3 -I -E -s -m pip install  --upgrade --no-warn-script-location -r "$1"
